...
{
    /// <summary>
    /// SenderConditionAlways condition type is used to direct request to a sender regardless of any property of the request itself
    /// </summary>
    /// <typeparam name="T">Type of request object to route</typeparam>
    public class SenderConditionAlways<T> : ISenderCondition<T>
    {
        /// <summary>
